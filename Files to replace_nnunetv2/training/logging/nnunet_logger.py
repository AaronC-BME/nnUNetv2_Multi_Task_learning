...
class nnUNetLogger(object):
    ...
    def __init__(self, verbose: bool = False):
        self.my_fantastic_logging = {
            ...
            'classification_accuracy': list(),
            'classification_precision': list(),
            'classification_recall': list(),
            'classification_f1_score': list(),
            'classification_macro_f1': list(),
            'lrs': list(),
    ...
    def plot_progress_png(self, output_folder):
        ...
        #plot for classification metrics
        ax = ax_all[3]
        ax.plot(x_values, self.my_fantastic_logging['classification_loss'][:epoch + 1], color='b', ls='-', label="learning rate", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['classification_macro_f1'][:epoch + 1], color='g', ls='-', label="learning rate", linewidth=4)
        ax.set_xlabel("epoch")
