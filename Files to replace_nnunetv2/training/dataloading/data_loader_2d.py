...
class nnUNetDataLoader2D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        if self.transforms is not None:
            ...
            classification_labels = [properties.get('classification_label', None) for properties in case_properties]
            return {'data': data_all, 'target': seg_all, 'keys': selected_keys, 'classification_labels': classification_labels}
